...
1. Open (or comment on) a Discussion thread.
2. Clearly reference the specific principle or section you are addressing.
...
This repository is intentionally small. The primary artifacts are:
